...
```bash
pip install --find-links https://github.com/atOCEANO/embeddable-market-simulation-library/releases/expanded_assets/v0.2.0 emsl
```
...
```bash
pip install --find-links https://github.com/atOCEANO/embeddable-market-simulation-library/releases/expanded_assets/v0.2.0 "emsl[tune,sb3]"
```

To choose the wheel yourself, take its URL from the release assets:

```bash
pip install https://github.com/atOCEANO/embeddable-market-simulation-library/releases/download/v0.2.0/emsl-0.2.0-cp39-abi3-manylinux_2_17_x86_64.manylinux2014_x86_64.whl
```
...
```bash
pip install "git+https://github.com/atOCEANO/embeddable-market-simulation-library.git@v0.2.0"
```
