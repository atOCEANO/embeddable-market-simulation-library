...
```bash
pip install --find-links https://github.com/atOCEANO/embeddable-market-simulation-library/releases/expanded_assets/v1.3.1 emsl
```
...
pip install "git+https://github.com/atOCEANO/embeddable-market-simulation-library.git@v1.3.1"   # or a tag
```
